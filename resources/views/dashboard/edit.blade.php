...
<div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="{{route('ppdb.update', $editdata['id'])}}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  ...
                  <input type="text" class="form-control" id="validationDefault02" name="nama_pemilik" value="{{ $editdata['nama_pemilik'] }}">
                </div>
                <div class="col-md-4">
                  <label for="validationDefaultUsername" class="form-label">Nominal</label>
                  <div class="input-group">
                    <input type="text" name="nominal" class="form-control"  id="dengan-rupiah" aria-describedby="inputGroupPrepend2" value="{{ $editdata['nominal'] }}">
                  <script>
